...
class Professional extends Authenticatable 
{
    ...
    protected $fillable = ['center_id','role_id','name','surnames','username','password','phone_number','email_address','address','number_locker','occupation','clue_locker','link_status','status'];
    ...
    public function registered_issues(): HasMany
    {
        return $this->hasMany(Hr_pending_issue::class, 'registered_by_professional_id');
    }
    public function derived_issues(): HasMany
    {
    ...
    {
        return $this->hasMany(Accident::class, 'registred_professional_id');
    }
