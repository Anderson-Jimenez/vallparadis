...
<nav class="w-screen flex items-center justify-between px-4 bg-white border-b-8 border-[#ff7300] h-[7vw]">
    <a href="{{route('dashboard')}}"><img src="{{ asset('img/logo.png') }}" alt="logo_vallparadis" class="w-[13vw]"></a>
    <el-dropdown class="inline-block">
        <button class="txt-orange flex items-center justify-center w-full gap-x-1.5 rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-xs inset-ring-1  hover:bg-gray-50">
