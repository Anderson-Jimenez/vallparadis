...
@auth
    ...
    <main class="flex justify-center py-10">
        <div class="w-3/4">
            ...
            <form action="{{ route('professional.update', $professional) }}"
                  method="POST"
                ...
                <div class="p-8 flex flex-col gap-8">
                    ...
                    <div>
                        ...
                        <input type="email"
                               name="email_address"
                               required
                               value="{{ $professional->email_address }}"
                               class="w-full border-2 border-gray-200 rounded-md px-3 py-2 mt-1">
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="text"
                               name="number_locker"
                               required
                               value="{{ $professional->number_locker }}"
                               class="w-full border-2 border-gray-200 rounded-md px-3 py-2 mt-1">
                    </div>
                    <div>
                        ...
                        <input type="text"
                               name="clue_locker"
                               required
                               value="{{ $professional->clue_locker }}"
                               class="w-full border-2 border-gray-200 rounded-md px-3 py-2 mt-1">
                    </div>
